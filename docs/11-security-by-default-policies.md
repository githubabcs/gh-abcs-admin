...
| Enterprise | **Allowed Actions** | Controls which actions can be used | **Restrict** - Allow only enterprise actions, GitHub actions, and explicitly allowlisted actions (do not rely on verified creators) | [Controlling access to public actions](https://docs.github.com/en/enterprise-cloud@latest/admin/enforcing-policies/enforcing-policies-for-your-enterprise/enforcing-policies-for-github-actions-in-your-enterprise#controlling-access-to-public-actions-and-reusable-workflows) |
